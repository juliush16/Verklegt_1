class Voyage:
    ...
    def __init__(self,flight_number, departing_from, arriving_at, departure, arrival, aircraft_id = None,captain = None, copilot = None, flight_service_manager = None, flight_attendants = None):
