...
def menu():
    ...
    while choice_str != 'q':
        ...
        print('Press "3" to see list all Pilots')
        print('Press "4" to see list all Captains')
        print('Press "5" to see list all Copilots')
        print('Press "6" to see list all Cabin Crew')
        print('Press "7" to see list all Flight Service Managers')
        print('Press "8" to see list all Flight Attendants')
